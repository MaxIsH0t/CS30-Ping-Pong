...
set CLASSPATH=%APP_HOME%\lib\PingPong-1.0.0.jar;%APP_HOME%\lib\joda-time-2.2.jar

@rem Execute Game
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %GAME_OPTS%  -classpath "%CLASSPATH%" me.maxish0t.pingpong.PingPong %CMD_LINE_ARGS%
